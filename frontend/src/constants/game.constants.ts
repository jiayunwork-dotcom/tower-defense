...
export const SKILLS = {
  freeze: { name: '全屏冰冻', description: '冻结所有怪物5秒', cooldown: 60, icon: '❄️' },
  meteor: { name: '陨石轰炸', description: '对区域内敌人造成大量伤害', cooldown: 60, icon: '☄️' },
  repair: { name: '修复所有塔', description: '修复所有被损坏的防御塔', cooldown: 60, icon: '🔧' },
  gold: { name: '金币雨', description: '获得100额外金币', cooldown: 60, icon: '💰' }
};

export const TARGET_STRATEGIES = {
  nearest: { name: '最近优先', description: '攻击射程内离塔最近的怪' },
  lowestHp: { name: '血最少优先', description: '优先收割残血' },
  nearestBase: { name: '距基地最近', description: '攻击跑得最远的怪' },
  bossFirst: { name: 'BOSS优先', description: '有BOSS时锁定BOSS' },
  strongest: { name: '最强优先', description: '攻击剩余血量最高的' }
};
